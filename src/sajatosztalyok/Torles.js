...
export default class Torles extends React.Component {
  ...
  render(){
    ...
    return(
      ...
      <Button variant="danger" onClick={async ()=>this.torles(item.anime_id)} style={{ width:'35%', alignSelf:'center', padding:10, fontWeight:'bold', color:'black' }}>Ezt szeretném törölni</Button>
